...
const defaultOptions: FormatCurrencyOptions = {
  nDecimals: Number.POSITIVE_INFINITY,
  padToDecimals: true,
...
export const formatCurrency = (
  ...
  if (
    nDecimals === 0 ||
    (nDecimals === Number.POSITIVE_INFINITY && decimalPart === 0n) ||
  ...
  if (nDecimals !== Number.POSITIVE_INFINITY && padToDecimals === true) {
...
export const divideBigInt = (numerator: BigNumber, denominator: BigNumber, targetPrecision?: bigint) => {
