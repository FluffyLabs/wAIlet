...
export type ChainId = "dot" | "dotAh" | "wnd" | "wndAh" | "ksm" | "ksmAh" | "roc" | "rocAh" | "pas" | "pasAh";
export type AssetId = "DOT" | "KSM" | "WND" | "ROC" | "PAS";

export type TeleportAsset = (from: PolkadotSigner, amount: bigint, to?: SS58String) => Transaction<any, any, any, any>;
